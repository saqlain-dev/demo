...
class IncidentReportController extends Controller
{
    ...
    public function getFleetDropDown(){
        ...
        $data['employees'] = Employee::with(['designation', 'department'])
                            ...
                            ->get();
        $data['vehicles']= Vehicle::query()->with('VehicleType','latestVehicleLog')->get();
        ...
        $data['program_budget'] = ProjectBudget::query()->with(['ProjectId','BudgetDetail.head_id','BudgetDetail.UnitType','BudgetDetail.activity'])->where('approval_status',1)->get();
