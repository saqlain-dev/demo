...
class GRNController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['grn_list']=GRN::query()->where('vendor_id',$vendor_id)->with('vendorDetail','poDetails')->get();
    ...
    {
        $data['view_grn']=GRN::query()->with('grnItem.itemDetail','vendorDetail','poDetails')->findOrFail($id);
