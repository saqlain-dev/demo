...
class InventoryController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = Inventory::query()->with('poDetail', 'location','itemVariants')->get();
...
//        $data['approval_request_status']=checkApprovalRequestStatus(12,$inventoryId);
        $data['inventory'] = Inventory::query()->with('poDetail', 'location','itemVariants.assignToEmploy','itemVariants.assignToEmploy.department','itemVariants.location','itemVariants.RackId','itemVariants.purchaseOrder','itemVariants.location','itemVariants.assignToDept','itemVariants.store')->findOrFail($inventoryId);
        return resp(1, 'Successful!', $data, Response::HTTP_OK);
    }
