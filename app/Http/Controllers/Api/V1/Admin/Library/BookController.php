...
class BookController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['books'] = Book::with('BookCategory','book_type','created_by','updated_by')->withCount('bookVariant')->orderByDesc('id')->get();

        $data['issuedBooks'] = BookIssued::where('status', 1)->count();
    ...
    public function show(Book $book): JsonResponse
    {
        ...
        $data['book'] = $book->load('BookCategory','book_type','created_by','updated_by','bookVariant.book_type');
    ...
    public function getBookSummary()
    {
        ...
        $totalIssuedBooks = BookIssued::where('status', 1)->count();
