...
class PurchaseRequestRfqController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['purchase_request_Rfq'] =$purchase_request_Rfq= PurchaseRequestRfq::with(['rfqVendors','items.itemDetail','quotationType','rfType','purchase_request', 'disposeRequest'])->orderByDesc('id')->get();
    ...
    public function attachRFQVendor(Request $request, PurchaseRequestRfq $purchaseRequestRfq)
    {
        ...
        if($purchaseRequestRfq->status == 1){
            ...
            try {
                ...
                $this->input['expiry_date']=date('Y-m-d',strtotime($request->expiry_date));
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $item = PurchaseRequestRfq::query()->create($request->all());
    ...
    public function show($id)
    {
        ...
        $data['item'] = PurchaseRequestRfq::query()->with(['rfqVendors','items.itemDetail','quotationType','rfType','purchase_request.department','disposeRequest.department'])->findOrFail($id);
    ...
    public function update(Request $request, PurchaseRequestRfq $PurchaseRequestRfq)
    {
        ...
        try {
            ...
            $PurchaseRequestRfq->update($request->all());
