...
class RiskRegisterController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['data'] = RiskRegister::query()->with(['riskRegisterDetails','financialYear', 'createdBy'])->get();
    ...
    public function show(RiskRegister $riskRegister)
    {
        ...
        $data['data'] = $riskRegister->load(['riskRegisterDetails' => ['riskCategory','riskProbability','riskImpact','overallRisk','riskApproach','riskStatus'], 'financialYear', 'createdBy']);
        return resp(1, 'Successful!', $data, Response::HTTP_OK);
    }
