...
class RiskRegisterDetailController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['data'] = RiskRegisterDetail::query()->with(['riskRegisterQuarterly'=>['createdBy','riskProbability','riskImpact','overallRisk']])->get();
    ...
    public function show(RiskRegisterDetail $riskRegisterDetail)
    {
        ...
        $data['data'] = $riskRegisterDetail->load(['department','riskRegisterQuarterly'=>['createdBy','riskProbability','riskImpact','overallRisk']]);
        return resp(1, 'Successful!', $data , Response::HTTP_OK);
    }
