...
class StockRequestController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = StockRequest::query()->with(['DepartmentId','LocationId','RequestedBy','StockRequestDetail','created_by','updated_by'])->get();
    ...
    public function show(StockRequest $stockRequest): JsonResponse
    {
        ...
        $data['stock_request'] = $stockRequest->load(['DepartmentId','LocationId','RequestedBy','StockRequestDetail.ItemCategoryId','created_by','updated_by']);
