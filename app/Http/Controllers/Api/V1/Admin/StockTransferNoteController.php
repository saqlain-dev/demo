...
class StockTransferNoteController extends Controller
{
    ...
    public function show(StockTransferNote $stockTransferNote): JsonResponse
    {
        ...
        $logBook = $stockTransferNote->load(['TransferBy','IssueStockId.StockRequestId','IssueStockId.StockRequestId.RequestedBy','IssueStockId.StockRequestId.DepartmentId','IssueStockDetailId','transferFrom','transferTo','created_by','updated_by','receivingNote.ReceiveBy']);
