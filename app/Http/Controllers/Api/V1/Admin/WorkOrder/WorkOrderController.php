...
class WorkOrderController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['work_order_listing']=$work_order_listing=WorkOrder::query()->with('WoItems.woItems','rfqDetail.items.itemDetail','rfqDetail.purchase_request','tenderDetail.tenderDetails.itemDetail','tenderDetail.purchaseRequest')->get();
