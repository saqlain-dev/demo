...
class CommunicationEventController extends Controller
{
    ...
    {
        $this->authorizeAny(['task_management_view', 'event_management_view']);
    ...
    {
        $this->authorizeAny(['task_management_create', 'event_management_create']);
    ...
    {
        $this->authorizeAny(['task_management_update', 'event_management_update']);
    ...
    {
        $this->authorizeAny(['task_management_delete', 'event_management_delete']);
