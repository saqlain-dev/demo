...
class AnnualBudgetController extends Controller
{
    ...
    public function show(AnnualBudget $annualBudget): JsonResponse
    {
        ...
        $data['annualBudget'] = $annualBudget->load(['BudgetType','created_by', 'updated_by','BudgetDetail' => ['ProjectId','HeadId.AccountTypeId'], 'projectBudgets.BudgetDetail.Head' => ['AccountTypeId', 'parent']]);
