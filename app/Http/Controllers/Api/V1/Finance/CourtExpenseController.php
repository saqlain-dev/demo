...
class CourtExpenseController extends Controller
{
    ...
    public function show(CourtExpense $courtExpense): JsonResponse
    {
        ...
        $data['court_expense'] = $courtExpense = $courtExpense->load(['EmployeeId.designation','PrId','created_by','updated_by']);
    ...
    public function sendCourtExpenseForApproval(CourtExpense $item)
    {
        ...
        if($approval_process->count() > 0 && $checkProcess == 0){
            ...
            CourtExpense::query()->where('id',$item->id)->update($update);
