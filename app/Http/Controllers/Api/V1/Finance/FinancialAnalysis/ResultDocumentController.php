...
use App\Models\Finance\FinancialAnalysis\ResultDocument;
...
class ResultDocumentController extends Controller
{
    ...
    {
        $data['listing'] = ResultDocument::with('preparedBy')->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if($request->hasFile('attachment')) {
                ...
                $response = $this->saveAttachment($file, 'resultDocument');
                if ($response) {
            ...
            $item = ResultDocument::query()->create($this->input);
    ...
    {
        $resultDocument = ResultDocument::with('preparedBy')->findOrFail($id);
        return resp('1', 'Successful!', $resultDocument, Response::HTTP_OK);
    }
    ...
    {
        $resultDocument = ResultDocument::findOrFail($id);
        ...
        try {
            ...
            $item = $resultDocument->update($this->input);
