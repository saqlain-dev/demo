...
class GrantFinancialReportController extends Controller
{
    ...
    {
        $grantFinancialReport = $grantFinancialReport->load(['NofoId.NofoDetail','DraftBy','created_by','updated_by']);
        return resp('1', 'Successful!', $grantFinancialReport, Response::HTTP_OK);
    }
