...
class NofoController extends Controller
{
    ...
    public function show(Nofo $nofo): JsonResponse
    {
        ...
        $data['nofo'] = $nofo->load(['donor_id','created_by', 'updated_by','NofoDetail.DueDeligenceDetail.NofoDetailId','DDelegence.DueDelegenceDetail.NofoDetailId','ProposalDetail.DraftBy','ContractDetail.DraftBy','FundRequestDetail','FinancialReport.DraftBy','CloseOutDetail.DraftBy','AppreciationLetter.DraftBy','LogFramework.DraftBy','lasInvoice','projectDetail.projectBudget']);
        return resp('1', 'Successful!', $data, Response::HTTP_OK);
    }
