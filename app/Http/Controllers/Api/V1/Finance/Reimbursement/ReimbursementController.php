...
class ReimbursementController extends Controller
{
    ...
    public function show(Reimbursement $reimbursement): JsonResponse
    {
        ...
        $data['reimbursement'] = $reimbursement = $reimbursement->load(['EmployeeId.designation','PrId.procurementDetail','Expenses','created_by','updated_by']);
    ...
    public function sendReimbursementForApproval(Reimbursement $item)
    {
        ...
        $item = Reimbursement::withSum('Expenses', 'amount')->find($item->id);
        $claimAmount = $item->expenses_sum_amount ?? 0;

        $approval_process_name=ApprovalProcessName::query()->where('id',51)->first();
