...
class SubGrantController extends Controller
{
    ...
    public function show(SubGrant $subGrant): JsonResponse
    {
        ...
        $subGrant = $subGrant->load(['NofoId.NofoDetail','PartnerId','created_by','updated_by','DDelegence.SgDueDelegenceDetail','SgProposal.DraftBy','SgLogFramework.DraftBy','SgContract.DraftBy','SgFundRequest.DraftBy','SgFinancialReport.DraftBy','SgCloseOut.DraftBy','SgAppriciation.DraftBy','subGrantBudget','lasInvoice']);
