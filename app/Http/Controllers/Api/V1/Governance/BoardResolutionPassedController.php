...
class BoardResolutionPassedController extends Controller
{
    ...
    public function reportIndex(Request $request)
    {
        ...
        $data['list'] = BoardResolutionPassed::whereBetween('date', [$request->date_from, $request->date_to])
        ->with('BoardMeetingId')
        ->get();
        return resp(1, 'Successful!', $data, Response::HTTP_OK);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if($mom){
                $board_member=Employee::query()->where('IsBoardMember',1)->whereNotIn('employee_type', [14, 16, 17, 18])->get();
