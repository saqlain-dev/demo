...
class ScheduledCheckInsController extends Controller
{
    ...
    public function show(ScheduledCheckIn $scheduledCheckIn)
    {
        ...
        $data['item'] = $scheduledCheckIn->load('comments.createdBy', 'performanceCheckIn', 'employeeWorkplan.employeeWorkplanActivity.KpiId', 'employeeWorkplan.employeeWorkplanActivity.sectionQuestions', 'performanceFactors.questionSection', 'performanceFactors.appriasalKpi');
        return resp(1, 'Successful!', $data, Response::HTTP_OK);
    }
