...
class HrDashboardStatsController extends Controller
{
    ...
    private function attendance_count()
    {
        ...
        $attendance['wh_employee']=$summary->get('WFH', 0);
    ...
    private  function reminders()
    {
        ...
        $reminders['employee_contract_end'] = EmployeeContract::query()->with('parentEmployeeContract.employee.department','parentEmployeeContract.employee.designation')->whereMonth('end_date', $currentMonth)->get();
        $probationPeriod = 3;
