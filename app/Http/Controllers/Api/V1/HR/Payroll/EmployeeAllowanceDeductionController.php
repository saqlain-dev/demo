...
class EmployeeAllowanceDeductionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            foreach($this->input['allowances'] as $allowance_deduction_id){
                ...
                $emp_allowance=EmployeeAllowanceDeduction::query()->where('employee_id',$this->input['employee_id'])->where('allowance_deduction_id',$allowance_deduction_id['allowance_deduction_id'])->first();
    ...
    public function employeeWiseDropDown()
    {
        ...
        $data['employee_list']=Employee::query()->with('employeeAllowanceDeduction.allowanceDeductionDetail')->whereNotIn('employee_type', [14, 16, 17, 18])->get();
