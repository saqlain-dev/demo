...
//            'log_book_view'
//        ]);
        $recruitmentPlan = RecruitmentPlan::query()->with(['BudgetId.BudgetDetail' => ['UnitType','Head' => ['parent','AccountTypeId']], 'created_by', 'updated_by','RecruitmentPlanDetail.BudgetDetailId'=>['UnitType','Head']])->findOrFail($id);
