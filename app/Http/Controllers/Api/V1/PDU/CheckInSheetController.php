...
class CheckInSheetController extends Controller
{
    ...
    public function projectByID(ProjectProfile $item){
        ...
        $data = $item->load([
            'projectGoals' =>
                [
                    'ProGoalIndicators' =>['proWorkPlanIndicators' => ['activities' =>['checkinsheetactivities']]],
                    'projectOutcomes' => [
                        'ProOutcomeIndicators' => ['proWorkPlanIndicators' => ['activities' =>['checkinsheetactivities']]],
                        'projectOutputs' => ['ProOutputIndicators' => ['proWorkPlanIndicators' => ['activities' =>['checkinsheetactivities']]],]
                    ]
                ]
        ]);
