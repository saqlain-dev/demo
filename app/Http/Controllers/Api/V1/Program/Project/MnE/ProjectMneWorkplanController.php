...
class ProjectMneWorkplanController extends Controller
{
    ...
    public function index($project)
    {
        ...
        $data = ProjectProfile::query()->with(['mneWorkplans' => ['focalPerson','responsiblePerson','created_by', 'updated_by', 'district', 'activity','mneKpi','comments.createdBy']])->findOrFail($project);
