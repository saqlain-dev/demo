...
//            }
    ...
    public function getProjectOutcomeOutputByProjectId($pid)
    {
        ...
        $res['ProjectGoals'] = ProjectRrfGoal::query()->with(['lasSpDetail','ProGoalIndicators' => ['SpIndicatorId','KpiMappedIndicators','proGoalIndicatorTargets']])->where('project_id', $pid)->get();
        $res['ProjectOutcomes'] = ProjectRrfOutcome::query()->with(['lasSpDetail','project_rrf_goal','ProOutcomeIndicators' => ['SpIndicatorId','KpiMappedIndicators','proOutcomeIndicatorTargets']])->where('project_id', $pid)->get();
        $res['ProjectOutputs'] = ProjectRrfOutput::query()->with(['lasSpDetail','project_rrf_goal','project_rrf_outcome','ProOutputIndicators' => ['SpIndicatorId','KpiMappedIndicators','proOutputIndicatorTargets']])->where('project_id', $pid)->get();
