...
//    }
    ...
    public function getRrfBySpId($spId)
    {
        ...
        $data['las_rrf'] = ResultResourceFramework::with(['sPDetail','goalIndicators'=>['SpIndicatorId','goalIndicatorTargets'],'rrf_outcomes'=>['outcomeIndicators'=>['SpIndicatorId','outcomeIndicatorsTarget','lasGoalIndicator'], 'sPDetail','lasGoal'],'rrf_outputs'=>['outputIndicators'=>['SpIndicatorId','outputIndicatorsTarget','lasGoalIndicator'],'sPDetail','lasGoal']])->where('las_sp_statement', $spId)->get();
