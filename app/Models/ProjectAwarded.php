...
class ProjectAwarded extends Model
{
    ...
    {
        return $this->hasOne(PurchaseOrder::class,'project_award_id');
    }
    public function awardWo(): HasOne
    {
        return $this->hasOne(WorkOrder::class,'project_award_id');
    }
    public function awardCc(): HasOne
    {
        return $this->hasOne(ConsultantContract::class,'project_award_id');
    }
