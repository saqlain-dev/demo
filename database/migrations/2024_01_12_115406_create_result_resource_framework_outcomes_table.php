...
return new class extends Migration
{
    ...
    {
        Schema::create('result_resource_framework_outcomes', function (Blueprint $table) {
            $table->id();
            $table->foreignId('project_id')->nullable()->constrained('project_profiles');
            $table->string('rrf_outcome_number',100)->nullable();
            $table->string('rrf_outcome_statement')->nullable();
            $table->string('rrf_outcome_indicator')->nullable();
...
//            $table->string('las_sp_indicator')->nullable();
    ...
    {
        Schema::dropIfExists('result_resource_framework_outcomes');
    }
};
