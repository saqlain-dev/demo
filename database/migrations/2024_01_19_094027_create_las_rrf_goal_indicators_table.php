...
return new class extends Migration
{
    ...
    {
        Schema::create('las_rrf_goal_indicators', function (Blueprint $table) {
            $table->id();
            $table->foreignId('rrf_goal_id')->nullable()->constrained('result_resource_frameworks');
    ...
    {
        Schema::dropIfExists('las_rrf_goal_indicators');
    }
};
