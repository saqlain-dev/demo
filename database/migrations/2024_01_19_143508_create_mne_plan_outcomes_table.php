...
return new class extends Migration
{
    ...
    {
        Schema::create('mne_plan_outcomes', function (Blueprint $table) {
            $table->id();
            $table->foreignId('plan_id')->nullable()->constrained('project_mne_plans');
            $table->foreignId('project_outcome_id')->nullable()->constrained('project_rrf_outcomes');
    ...
    {
        Schema::dropIfExists('mne_plan_outcomes');
    }
};
