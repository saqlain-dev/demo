...
return new class extends Migration
{
    ...
    {
        Schema::create('mne_plan_outputs', function (Blueprint $table) {
            $table->id();
            $table->foreignId('plan_id')->nullable()->constrained('project_mne_plans');
            $table->foreignId('project_output_id')->nullable()->constrained('project_rrf_outputs');
    ...
    {
        Schema::dropIfExists('mne_plan_outputs');
    }
};
