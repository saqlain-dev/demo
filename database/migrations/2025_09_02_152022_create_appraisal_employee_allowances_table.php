...
return new class extends Migration
{
    ...
    {
        Schema::create('appraisal_employee_allowances', function (Blueprint $table) {
            $table->id();
            ...
            $table->tinyInteger('IsVariableAllowance')->default(0);
    ...
    {
        Schema::dropIfExists('appraisal_employee_allowances');
    }
};
