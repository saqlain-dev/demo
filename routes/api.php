...
use App\Http\Controllers\API\V1\Admin\TaskEventController;
use App\Http\Controllers\Api\V1\Admin\VendorQuotationDetailController;
use App\Http\Controllers\API\V1\Admin\VendorRecommendationController;
...
use App\Http\Controllers\Api\V1\LearningLog;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Route;
use App\Http\Controllers\EmailController;
use App\Http\Controllers\Api\V1\Complaint;
use App\Http\Controllers\API\V1\HR\SalaryIncrment\AppraisalEmployeeAllowanceController;
use App\Http\Controllers\API\V1\HR\SalaryIncrment\AppraisalSalarySetupController;
use App\Http\Controllers\API\V1\HR\SalaryIncrment\EffectSalaryIncrementController;
...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::patch('types/{id}/restore', [TypeValue\TypeController::class, 'restore']);
    ...
    // Employee
    Route::post('employee-status-report',[Configuration\EmployeeController::class,'getEmployeeStatusReport']);
    ...
    Route::post('employee-off-boarding-assets',[Configuration\EmployeeController::class,'employeeOffBoarding']);
    Route::post('employee-off-assets',[Configuration\EmployeeController::class,'employeeAssets']);
    ...
    Route::get('download-employee-files/{id}', [Configuration\EmployeeController::class, 'downloadEmployeeFiles']);
    Route::put('/employee-card/{id}', [Configuration\EmployeeController::class, 'updateCard']);
    ...
    Route::post('update-project-rrf-indicator-progress', [Program\Project\ProjectRrfGoalController::class, 'updateProjectRrfIndicatorProgress']);
    ...
    Route::get('project-profile-workplan-view/{item}', [Program\Project\ProjectRrfOutputController::class,'projectProfileWorkPlanView']);
    ...
    Route::post('project-progress', [Progress\ProgressWorkplanController::class, 'getProjectProgress']);
    Route::post('project-goal-progress', [Progress\ProgressWorkplanController::class, 'getProjectGoalProgress']);
    ...
    // Admin
    Route::post('vendor-approval/{item}',[Admin\VendorController::class,'sendVendorForApproval']);
    ...
    Route::post('applied-event', [Admin\VendorController::class, 'appliedEvent']);
    ...
    Route::apiResource('vehicle-records', Admin\Fleet\VehicleRecordController::class);
    Route::get('vehicle-log/{id}', [Admin\Fleet\VehicleRequestController::class,'logBook']);
    Route::post('vehicle-log-book/{id}', [Admin\Fleet\VehicleRequestController::class,'logBookFilter']);
    ...
    Route::get('unassigned-vehicle-dropdown', [Admin\Fleet\AssignVehicleController::class,'getUnAssignedVehicleDropDown']);
    Route::post('assign-vehicle-logs', [Admin\Fleet\AssignVehicleLogController::class, 'index']);
    ...
    // Fuel
    Route::get('fuel-request-invoice-dropdown', [Admin\Fleet\FuelRequestController::class,'dropdown']);
    ...
    Route::get('hr-pending-approval', [HR\Recruitment\ManageJobController::class,'getHrPendingApproval']);
    ...
    Route::get('employee-contract-parent/employee/{emp_id}',[HR\Recruitment\EmployeeContractParentController::class, 'showByEmployee']);
    ...
    Route::post('update-generated-letter/{generatedLetter}', [Configuration\GeneratedLetterController::class,'updateLetter']);
    ...
    Route::post('update-procurement-type',[Finance\Budget\ProjectBudgetDetailController::class,'updateProcType']);
    Route::post('update-project-budget-item',[Finance\Budget\ProjectBudgetController::class,'updateProjectBudgetItem']);
    ...
    Route::post('project-budget-balance',[Finance\Budget\ProjectBudgetController::class, 'getProjectBudgetBalance']);
    Route::get('tax-dropdown', [Finance\ChartOfAccount\ChartOfAccountController::class,'taxDropdown']);
    ...
    //Grant Proposal
    Route::get('grant-dropdown',[Finance\Grants\GrantProposalController::class,'grantDropDown']);
    ...
    Route::post('grant-financial-report-approval/{item}',[Finance\Grants\GrantFinancialReportController::class,'sendGrantFinancialReportForApproval']);
    ...
    //Sub Grants Budget
    Route::apiResource('sub-grant-budget', Finance\SubGrants\SubGrantBudgetController::class);
//  Due Delegence
...
// Sub Grant Proposal
    ...
    Route::post('sub-grant-financial-report-approval/{item}',[Finance\SubGrants\SubGrantFinancialReportController::class,'sendSubGrantFinancialReportForApproval']);
    ...
    Route::apiResource('court-advocate-expense', Finance\CourtAdvocateExpenseController::class);
    Route::get('court-advocate-expense-by-user', [Finance\CourtAdvocateExpenseController::class,'courtAdocateExpenseByUser']);
    ...
    Route::apiResource('tax-management', Finance\TaxManagementController::class);
    Route::post('import-tax', [Finance\TaxManagementController::class, 'importCsv']);
    Route::apiResource('country', \App\Http\Controllers\CountryController::class);
    Route::post('import-countries', [\App\Http\Controllers\CountryController::class, 'importCsv']);
    ...
    Route::apiResource('audit-schedules', Finance\Audit\AuditScheduleController::class);
    Route::apiResource('audit-plan-report', Finance\Audit\AuditPlanReportController::class);
    Route::apiResource('ticket-schedules', Finance\Audit\TicketScheduleController::class);
    ...
    // Aproval Process
    Route::match(['get', 'post'], 'approvals', [ApprovalProcess\ApprovalProcessController::class, 'getPendingApprovals']);
    Route::post('approved-approvals',[ApprovalProcess\ApprovalProcessController::class,'getApprovedApprovals']);
    ...
    Route::post('save-signature',[Configuration\UserController::class,'saveSignature']);
    Route::post('active-inactive',[Configuration\UserController::class,'userActiveInactive']);
    ...
    Route::post('/item-variant-logs', [Admin\Item\ItemVariantLogController::class, 'index']);
    ...
    Route::post('add-multiple-purchase-request-item',[Admin\PurchaseRequest\PurchaseRequestController::class,'addMultiplePRItems']);
    ...
    // Dispose Requests
    Route::post('dispose-request-approval/{item}',[Admin\DisposeRequest\DisposeRequestController::class,'sendDisposeRequestsForApproval']);
    ...
    Route::post('invoice-atr-details', [Admin\InvoiceAtrDetailController::class,'store']);
    Route::post('invoice-vehicle-maintenance-details', [Admin\InvoiceVehicleMaintenanceDetailController::class,'store']);
    ...
    Route::post('purchase-request-rfqs-item-add-multiple', [Admin\PurchaseRequest\PurchaseRequestRfqController::class,'addMultiplePrItem']);
    ...
    Route::post('/purchase-request-rfq-logs', [Admin\PurchaseRequest\PurchaseRequestRFQLogController::class, 'index']);
    ...
    Route::post('tender-multiple-item-add', [Admin\TenderController::class, 'addMultipleItems']);
    ...
    Route::post('/tender-logs', [Admin\TenderLogController::class, 'index']);
    ...
    Route::post('stock-request-report',[Admin\StockRequestController::class,'filterStockRequest']);
    ...
    Route::post('add-procurement-items', [Admin\ProcurementController::class, 'addItems']);
    ...
    Route::post('update-procurement-item', [Admin\ProcurementController::class, 'updateProcurementItem']);
    ...
    Route::get('vendor-dashboard',[Admin\VendorController::class, 'dashboard']);
    ...
    Route::get('projects',[Admin\ComparativeController::class,'rfqProjects']);
     Route::get('projects-report',[Admin\ComparativeController::class,'rfqProjectsReport']);
    ...
    Route::post('purchase-order-approval/{item}', [Admin\PurchaseOrder\PurchaseOrderController::class, 'sendPoRequestForApproval']);
    ...
    Route::post('update-check-by',[Admin\GRN\GRNController::class,'updateCheckBy']);
    Route::apiResource('grn',Admin\GRN\GRNController::class);

    // Invoice

    Route::post('verified-invoice/{invoice}',[Admin\Invoice\InvoiceController::class,'verifiedInvoice']);
    ...
    // Work Order
    Route::post('work-completion-approval/{item}',[Admin\WorkOrder\WorkCompletionController::class,'sendWorkCompletionForApproval']);
    Route::apiResource('work-completion',Admin\WorkOrder\WorkCompletionController::class);
    Route::post('work-completion-by-vendor',[Admin\WorkOrder\WorkCompletionController::class, 'WorkCompletionByVendor']);
    Route::post('work-order/vendor-acknowledged',[Admin\WorkOrder\WorkOrderController::class,'vendorAcknowledged']);

    Route::post('work-order-approval/{item}',[Admin\WorkOrder\WorkOrderController::class,'sendWorkOrderRequestForApproval']);
    Route::apiResource('work-order',Admin\WorkOrder\WorkOrderController::class);
    Route::post('update-last-acknowledged-work-order',[Admin\WorkOrder\WorkOrderController::class,'updateLastAcknowledged']);

    // consultant_contract
    Route::post('consultant-contract-approval/{item}',[Admin\ConsultantContract\ConsultantContractController::class,'sendConsultantContractForApproval']);
    ...
    // HR Employee Leave
    Route::post('employee-leave-report',[HR\Leaves\EmployeeLeaveController::class,'getEmployeeLeaveReport']);
    ...
    Route::post('leave-lisiting-report',[HR\Leaves\EmployeeLeaveController::class,'leaveListingReport']);
    ...
    Route::post('update-employee-complaint/{complaint}', [HR\Complaint\ComplaintController::class, 'updateEmployeeComplaint']);
    Route::get('employee/{employee}/complaints', [HR\Complaint\ComplaintController::class, 'employeeAssignedComplaints']);

    Route::apiResource('complaint-meeting',HR\Complaint\ComplaintMeetingController::class);
    ...
    Route::post('advance-salaries-report',[HR\AdvanceSalary\AdvanceSalaryController::class, 'advanceSalaries']);
    ...
    Route::get('emp-salary-coa-setup-dropdown',[HR\Payroll\EmployeeSalarySetupController::class,'salaryCoaSetupDropDown']);
    ...
    Route::post('update-payroll-detail',[HR\Payroll\EmployeePayrollMasterController::class,'updatePayrollAuditDetail']);
    ...
    Route::get('governance-dashboard',[Governance\BoardMeetingAgendaController::class,'governanceDashboard']);
    ...
    Route::get('minutes-of-meeting-dropdown',[Governance\MinuteOfMeetingController::class,'minutesOfMeetingDropDown']);
    ...
    Route::post('board-resolution-passed-report',[Governance\BoardResolutionPassedController::class,'reportIndex']);
    ...
    Route::get('audit-trail-log',[Finance\Voucher\VoucherController::class,'getAuditTrailLog']);
    ...
    Route::get('posted-voucher-listing',[Finance\Voucher\VoucherController::class,'getPostedVoucherListing']);
    Route::get('audit-vouchers',[Finance\Voucher\VoucherController::class,'getAuditVouchers']);
    Route::get('audit-vouchers-approval',[Finance\Voucher\VoucherController::class,'getAuditVoucherApproval']);
    Route::post('verified-voucher/{voucher}',[Finance\Voucher\VoucherController::class,'verifiedVoucher']);
    Route::post('upload-attachment/{voucher}',[Finance\Voucher\VoucherController::class,'uploadAttachment']);
    Route::post('delete-voucher-attachment',[Finance\Voucher\VoucherController::class,'deleteVoucherAttachment']);
    Route::post('delete-voucher',[Finance\Voucher\VoucherController::class,'deleteVoucher']);
    Route::post('posted-voucher/{voucher}',[Finance\Voucher\VoucherController::class,'postedVoucher']);
    Route::post('bulk-posted-voucher',[Finance\Voucher\VoucherController::class,'bulkPostedVoucher']);

    Route::post('draft-voucher',[Finance\Voucher\VoucherController::class,'draftVoucher']);
    Route::post('save-voucher',[Finance\Voucher\VoucherController::class,'saveVoucher']);
    Route::get('jv-vouchers',[Finance\Voucher\VoucherController::class,'getJvVouchers']);
    ...
    Route::post('income-expense-detail-report',[Finance\ReportController::class,'getIncomeExpanseDetailReport']);
    Route::post('financial-income-tax',[Finance\ReportController::class,'getIncomeTaxReport']);
    Route::post('income-tax',[Finance\ReportController::class,'getVendorIncomeTaxReport']);
    Route::post('income-tax-detail',[Finance\ReportController::class,'getEmployeeDetailIncomeTaxReport']);
    Route::post('sale-tax',[Finance\ReportController::class,'getSaleTaxReport']);
    Route::post('balance-sheet',[Finance\ReportController::class,'getBalanceSheet']);
    Route::post('cash-flow',[Finance\ReportController::class,'getCashFlow']);
    Route::post('general-ledger',[Finance\ReportController::class,'getGeneralLedger']);
    Route::post('general-ledger-detail',[Finance\ReportController::class,'getGeneralLedgerDetail']);
    ...
    Route::post('payable-receivable-report',[Finance\ReportController::class,'getPayableReceivableReport']);

    Route::post('finance_payable_receivable',[Finance\ReportController::class,'getPayableAndReceivableReport']);
    Route::get('finance-dashboard',[Finance\ReportController::class,'financeDashboard']);
    Route::get('budget-variance-dropdown',[Finance\ReportController::class,'budgetVarianceDropdown']);
    Route::post('budget_variance_item_wise_report',[Finance\ReportController::class,'BudgetVarianceItemWiseReport']);
    ...
    Route::post('employee-contract-report',[HR\Recruitment\EmployeeContractParentController::class,'employeeContractReport']);
    ...
    // Tax Settings
    Route::get('tax-settings-dropdown',[Finance\Tax\TaxSettingController::class, 'getTaxSettingsDropdowns']);
    Route::apiResource('tax-settings', Finance\Tax\TaxSettingController::class);

    // Tax Settings

    Route::apiResource('tax-filing', Finance\Tax\TaxFilingStatusController::class);

    // Tax Settings
    Route::get('learning-log-dropdown',[LearningLog\LearningLogController::class, 'getLearningLogDropdowns']);
    Route::apiResource('learning-log', LearningLog\LearningLogController::class);
    Route::apiResource('learning-log-detail', LearningLog\LearningDetailController::class);

    // Las Complaint
    Route::get('las-complaint-dropdown',[Complaint\LasComplaintController::class, 'getLasComplaintDropdowns']);
    Route::get('complaint-assign',[Complaint\LasComplaintController::class, 'assignComplaint']);
    Route::get('complaint-response',[Complaint\LasComplaintController::class, 'complaintResponse']);
    Route::apiResource('las-complaint', Complaint\LasComplaintController::class);


    // Admin Reporting
    Route::post('procurement-plan-report',[Admin\AdminReportController::class,'getProcurementPlan']);

    // RFQ Committee
    Route::apiResource('rfq-committee', Admin\PurchaseRequest\RfqCommitteeController::class);

    // RFQ MoM
    Route::get('rfq-mom-dropdown',[Admin\PurchaseRequest\RfqMinutesOfMeetingController::class,'rfqMomDropDown']);
    Route::apiResource('rfq-mom',Admin\PurchaseRequest\RfqMinutesOfMeetingController::class);


    // Fixed Asset Register

    Route::get('fixed-asset-register-dropdown',[Admin\Asset\FixedAssetRegisterController::class,'fixedAssetRegDropDown']);
    Route::post('fixed-asset-variants',[Admin\Asset\FixedAssetRegisterController::class,'getFixedAssetVariants']);
    Route::post('add-fixed-asset',[Admin\Asset\FixedAssetRegisterController::class,'addNewAssetToExistingRegister']);
    Route::apiResource('fixed-asset-register',Admin\Asset\FixedAssetRegisterController::class);

    Route::apiResource('rfq-waiver',Admin\PurchaseRequest\RfqWaiverController::class);
    Route::post('approve-rfq-waiver',[Admin\PurchaseRequest\RfqWaiverController::class, 'ApproveRFQ']);
    Route::post('/user-activities', [\App\Http\Controllers\UserActivityController::class, 'index']);
    Route::post('/logout-track', [\App\Http\Controllers\UserActivityController::class, 'logoutTrack']);


    //Off boarding API
    Route::apiResource('offboarding',Admin\OffBoardingQuestionController::class);
    Route::post('employee/offboarding-answers', [Admin\OffBoardingQuestionController::class, 'storeEmployeeAnswers']);
    Route::get('employee/offboarding-responses/{employee_offboard_id}', [Admin\OffBoardingQuestionController::class, 'responses']);

    //Meeting Booking
    Route::post('meeting-booking-approval/{item}',[Admin\MeetingBookingController::class,'sendMeetingBookingForApproval']);
    Route::get('meeting-bookings-dropdown',[Admin\MeetingBookingController::class,'getMeetingBookingsDropdown']);
    Route::apiResource('meeting-bookings',Admin\MeetingBookingController::class);
    Route::post('visit-reimbursement-approval/{item}',[Admin\VisitReimbursementController::class,'sendVisitReimbursementForApproval']);
    Route::apiResource('visit-reimbursements',Admin\VisitReimbursementController::class);
    Route::get('reimbursement-dropdown', [Admin\VisitReimbursementController::class,'reimbursementDropdown']);

    // Event Management
    Route::post('event-management-approval/{item}',[Admin\EventManagementController::class,'sendEventManagementForApproval']);
    Route::apiResource('event-management', Admin\EventManagementController::class);
    Route::apiResource('event-management-details', Admin\EventMangementDetailsController::class);
    Route::get('event-management-dropdown', [Admin\EventManagementController::class, 'getEventManagementDropdowns']);


    Route::get('event-management-vendor', [Admin\VendorController::class,'vendorEventList']);
    Route::post('save-event-vendor/{event}', [Admin\EventManagementController::class,'attachEventVendor']);
   // Event Management Quotation
    Route::get('get-event-management-quotation/{event}', [Admin\VendorEventManagmentQuotationController::class,'getEventManagementQuotationList']);
    Route::apiResource('event-management-quotation', Admin\VendorEventManagmentQuotationController::class);
    Route::post('accept-event-quotation/{event}', [Admin\VendorEventManagmentQuotationController::class,'acceptQuotation']);

    Route::post('invoice-event-management', [Admin\EventManagementController::class,'invoice']);


    //Vehicle Requistion Invoice
    Route::post('invoice-vr-details', [Admin\VehicleRequistionInvoiceController::class,'store']);

    //award quptation item
    Route::post('award-quotations-items',[VendorQuotationDetailController::class,'awardQuotationItem']);

    //Salary Increments
    Route::post('salary-increments/{item}',[SalaryIncrementController::class,'sendSalaryIncrementForApproval']);
    Route::apiResource('salary-increments', SalaryIncrementController::class);
    Route::post('add-salary-increment-employee', [SalaryIncrementController::class, 'addSalaryIncrementEmployee']);
    Route::get('delete-salary-increment-employee/{salary_increment_employee_id}', [SalaryIncrementController::class, 'deleteSalaryIncrementEmployee']);
    Route::get('salary-increment-dropdown',[SalaryIncrementController::class,'salaryIncrementDropdown']);
    Route::post('change-employee-details', [SalaryIncrementController::class, 'changeEmployeeDetails']);
    Route::get('employee-salary-details/{id}', [SalaryIncrementController::class, 'employeeSalaryDetails']);
    Route::post('employee-increment-update', [SalaryIncrementController::class, 'employeeIncrementUpdate']);
    Route::apiResource('appraisal-salary-setups', AppraisalSalarySetupController::class);
    Route::apiResource('appraisal-salary-allowances', AppraisalEmployeeAllowanceController::class);
    Route::post('effect-appraisal-salary-increment',[EffectSalaryIncrementController::class,'effectSalaryIncrement']);

    Route::get('get-pr/{id}', [Admin\PurchaseRequest\PurchaseRequestController::class, 'getPRById']);

    Route::post('emp-leave-joining-report', [Configuration\EmployeeController::class, 'empListing']);

    Route::post('leave-approval-report', [HR\Leaves\EmployeeLeaveController::class, 'leaveApprovalReport']);

    Route::apiResource('event-tasks', TaskEventController::class);
    Route::get('event-tasks-dropdown', [TaskEventController::class, 'eventTasksDropdown']);

    //Get Purchase by procurement id
    Route::post('get-purchase-by-procurement', [Admin\PurchaseRequest\PurchaseRequestController::class, 'getPurchaseByProcurementId']);
